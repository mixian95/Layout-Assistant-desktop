...
pkg.scripts = {
  ...
  'desktop:syntax': 'node scripts/desktop-syntax-check.mjs .',
  'portable:build':
    'vite build --config vite.config.portable.ts && node scripts/desktop-portable-fixup.mjs dist-portable',
...
for (const relative of [
  ...
  'scripts/desktop-portable-fixup.mjs',
